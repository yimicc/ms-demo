...
assertCurl 200 "curl http://$HOST:$PORT/MsDemoMonolith/product-composite/1 -s"
...
assertCurl 200 "curl http://$HOST:$PORT/MsDemoMonolith/product-composite/113 -s"
assertEqual 113 $(echo $RESPONSE | jq .productId)
assertEqual 0 $(echo $RESPONSE | jq ".recommendations | length")
assertEqual 3 $(echo $RESPONSE | jq ".reviews | length")

# Verify that no reviews are returned for productId 213
assertCurl 200 "curl http://$HOST:$PORT/MsDemoMonolith/product-composite/213 -s"
